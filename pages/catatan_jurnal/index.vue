  ...
  <div class="form-container">
    <form @submit.prevent="handleSubmit">
      ...
      <table border="1">
        ...
        <tbody>
          <tr>
            <td><input v-model="tableData.Tanggal" type="date" :readonly="isGuru" /></td>
            <td><input v-model="tableData.Uraian_Kegiatan" type="text" /></td>
            <td>
              <select v-model="tableData.Verifikasi_Guru" :disabled="!isGuru">
                <option value="">Pilih Status</option>
                <option value="✓">✓ (Selesai)</option>
                <option value="✗">✗ (Belum Selesai)</option>
              </select>
            </td>
            <td><input v-model="tableData.Catatan_Instruktur" type="text" :readonly="!isGuru" /></td>
          </tr>
        </tbody>
      </table>
